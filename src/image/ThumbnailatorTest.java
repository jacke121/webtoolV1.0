...
public class ThumbnailatorTest {
 ...
 private void test1() throws IOException {
   ...
   */
  Thumbnails.of("images/cao_conew1.jpg").size(200, 200).toFile("C:/image_200x200.jpg");
  Thumbnails.of("images/cao_conew1.jpg").size(100, 100).toFile("C:/image_100x100.jpg");
  Thumbnails.of("images/cao_conew1.jpg").size(50, 50).toFile("C:/image_50x50.jpg");
  Thumbnails.of("images/cao_conew1.jpg").size(25, 25).toFile("C:/image_25x25.jpg");
 ...
 private void test4() throws IOException {
   ...
   */
  Thumbnails.of("images/cao_conew1.jpg").size(1280, 1024).rotate(25).toFile(
    "C:/image+90.jpg");
 ...
 private void test5() throws IOException {
  ...
  Thumbnails.of("images/test.jpg").size(1280, 1024).watermark( Positions.BOTTOM_RIGHT,ImageIO.read(new File("images/watermark.png")), 0.5f)
    .outputQuality(0.8f).toFile("C:/image_watermark_bottom_right.jpg"); Thumbnails.of("images/test.jpg").size(1280, 1024).watermark(
    Positions.CENTER,    ImageIO.read(new File("images/watermark.png")), 0.5f) .outputQuality(0.8f).toFile("C:/image_watermark_center.jpg");
 }
